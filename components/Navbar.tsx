    ...
    <nav className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md text-gray-800 dark:text-gray-100 p-4 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          <Link
            href="/"
            className="font-semibold text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary-light"
          >
            Home
          </Link>
          <Link
          ...
          <div className="w-48 text-right">
            {status === "loading" ? (
              ...
              <Link href="/login" passHref legacyBehavior>
                <a className="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
                  Sign In
                </a>
              </Link>
            )}
